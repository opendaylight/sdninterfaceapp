...
public abstract class AbstractIpv6ReachabilityTopologyBuilderModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.bgp.topology.provider.Ipv6ReachabilityTopologyBuilderModuleMXBean,org.opendaylight.controller.config.yang.topology.TopologyReferenceServiceInterface {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.bgp.topology.provider.AbstractIpv6ReachabilityTopologyBuilderModule.class);
    ...
    private final AbstractIpv6ReachabilityTopologyBuilderModule oldModule;
    ...
    public AbstractIpv6ReachabilityTopologyBuilderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractIpv6ReachabilityTopologyBuilderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractIpv6ReachabilityTopologyBuilderModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    public boolean canReuseInstance(AbstractIpv6ReachabilityTopologyBuilderModule oldModule){
    ...
    public boolean isSame(AbstractIpv6ReachabilityTopologyBuilderModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractIpv6ReachabilityTopologyBuilderModule that = (AbstractIpv6ReachabilityTopologyBuilderModule) o;
