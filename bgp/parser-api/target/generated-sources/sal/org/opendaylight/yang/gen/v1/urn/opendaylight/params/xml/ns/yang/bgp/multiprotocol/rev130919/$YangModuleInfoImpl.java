...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "bgp-multiprotocol";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:bgp-multiprotocol";
    private final String revision = "2013-09-19";
    private final String resourcePath = "/META-INF/yang/bgp-multiprotocol.yang";
