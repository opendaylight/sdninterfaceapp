...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "bgp-message";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:bgp-message";
    private final String revision = "2013-09-19";
    private final String resourcePath = "/META-INF/yang/bgp-message.yang";
