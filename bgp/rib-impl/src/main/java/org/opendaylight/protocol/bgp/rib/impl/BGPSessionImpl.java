...
public class BGPSessionImpl extends AbstractProtocolSession<Notification> implements BGPSession {
	...
	LOG.info("BGP Hold-----Timer new value: {}", this.holdTimerValue);
  	...
  	LOG.info("before calling sdni");
        //call SdniWrapper to execute sdni message exchange
        SdniWrapper sdniwrapper = new SdniWrapper();
        sdniwrapper.activateSdniParser(); 
