...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev131125.linkstate.destination.c.linkstate.destination.LinkSdniDescriptorsBuilder;
...
public class LinkstateAdjRIBsInTest {
    ...
    public void testAddRemoveLink() {
        ...
        this.dBuilder.setLinkSdniDescriptors(new LinkSdniDescriptorsBuilder().setSdniIdentifier("Sample Data").build());
