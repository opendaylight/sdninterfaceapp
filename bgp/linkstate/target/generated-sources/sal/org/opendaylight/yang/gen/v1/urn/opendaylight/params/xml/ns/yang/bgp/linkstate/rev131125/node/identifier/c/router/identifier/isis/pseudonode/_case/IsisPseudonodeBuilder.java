 ...
 *     bgp-linkstate
 * Schema path:
 *     [(urn:opendaylight:params:xml:ns:yang:bgp-linkstate?revision=2013-11-25)node-identifier/node-identifier/c-router-identifier/isis-pseudonode-case/isis-pseudonode]
 */
    ...
    */
    ...
    private static final class IsisPseudonodeImpl implements IsisPseudonode {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            IsisPseudonodeImpl other = (IsisPseudonodeImpl) obj;
            if (_isIsRouterIdentifier == null) {
                if (other._isIsRouterIdentifier != null) {
                    return false;
                }
            } else if(!_isIsRouterIdentifier.equals(other._isIsRouterIdentifier)) {
                return false;
            }
            if (_psn == null) {
                if (other._psn != null) {
            ...
            } else if(!_psn.equals(other._psn)) {
                return false;
            }
