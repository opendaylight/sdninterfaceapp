    ...
    */
    ...
    private static final class LinkSdniDescriptorsImpl implements LinkSdniDescriptors {
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            LinkSdniDescriptorsImpl other = (LinkSdniDescriptorsImpl) obj;
            if (_sdniIdentifier == null) {
                if (other._sdniIdentifier != null) {
                    return false;
                }
            } else if(!_sdniIdentifier.equals(other._sdniIdentifier)) {
                return false;
            }
            if (_sdniParameter == null) {
                if (other._sdniParameter != null) {
                    return false;
                }
            } else if(!_sdniParameter.equals(other._sdniParameter)) {
                return false;
            }
