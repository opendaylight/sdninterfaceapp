 ...
 * <i>bgp-linkstate/update/path-attributes/(urn:opendaylight:params:xml:ns:yang:bgp-multiprotocol?revision=2013-09-19)mp-reach-nlri/advertized-routes/destination-type/(urn:opendaylight:params:xml:ns:yang:bgp-linkstate?revision=2013-11-25)destination-linkstate-case</i>
 */
public interface DestinationLinkstateCase
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev131125.update.path.attributes.mp.reach.nlri.advertized.routes.destination.type.DestinationLinkstateCase>,
    DestinationType
{
