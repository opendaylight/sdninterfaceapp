...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "odl-bgp-rib-spi-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:bgp:rib:spi";
    private final String revision = "2013-11-15";
    private final String resourcePath = "/META-INF/yang/odl-bgp-rib-spi-cfg.yang";
