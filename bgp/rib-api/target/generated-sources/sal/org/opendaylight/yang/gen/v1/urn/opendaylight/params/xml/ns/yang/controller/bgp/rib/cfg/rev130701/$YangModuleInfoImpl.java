...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "odl-bgp-rib-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:bgp:rib:cfg";
    private final String revision = "2013-07-01";
    private final String resourcePath = "/META-INF/yang/odl-bgp-rib-cfg.yang";
