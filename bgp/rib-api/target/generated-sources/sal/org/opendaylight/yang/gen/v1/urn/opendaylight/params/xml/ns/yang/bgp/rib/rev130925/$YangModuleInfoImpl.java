...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "bgp-rib";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:bgp-rib";
    private final String revision = "2013-09-25";
    private final String resourcePath = "/META-INF/yang/bgp-rib.yang";
