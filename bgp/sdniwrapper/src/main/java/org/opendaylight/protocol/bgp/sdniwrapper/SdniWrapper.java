    ...
    */
    ...
    public String parseSDNIMessage(String sdnimsg) {
        try {
          ...
          peer_information.put(networkData.getControllers().toString(),networkData);
              LOG.trace("After storing sdni message in peer_info:"+ peer_information.get(networkData.getControllers().toString()));
              return "success";
      }
