package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.bgp.reachability.ipv4.rev131115 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "odl-bgp-treachability-ipv4-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:bgp:reachability:ipv4";
    private final String revision = "2013-11-15";
    private final String resourcePath = "/META-INF/yang/odl-bgp-reachability-ipv4-cfg.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.topology.rev131115.$YangModuleInfoImpl.getInstance());
