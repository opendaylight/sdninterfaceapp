package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.bgp.topology.provider.rev131115 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "odl-bgp-topology-provider-cfg";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:bgp:topology:provider";
    private final String revision = "2013-11-15";
    private final String resourcePath = "/META-INF/yang/odl-bgp-topology-provider-cfg.yang";
