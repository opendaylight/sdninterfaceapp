...
public class SdniNorthbound {
    ...
    private static final String NOT_AUTHORIZED_MESSAGE = 
        new String("User is not authorized to perform this operation on container ");

    OpendaylightSdniManager sdniManager ;
    List<NodeConnectorStatisticsAndPortNumberMap> list = 
    ...
    /**
     * Retrieve the Network Capabilities QOS Data like node, port, receive
     * packets etc., from SDNiAggregator
     * 
     *    @return NetworkCapabilitiesQOS Example: Request URL:
     *     http://localhost:8080/controller/nb/v2/sdni/default/qos Response
     *     Body in JSON:
     *     [{"node":"00:00:00:00:00:00:00:04","port":"0","receivePackets":0,
     *     "transmitPackets":0,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:04","port":"1","receivePackets":61,
     *     "transmitPackets":63,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:04","port":"2","receivePackets":47,
     *     "transmitPackets":47,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:04","port":"3","receivePackets":62,
     *     "transmitPackets":64,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:06","port":"4","receivePackets":70,
     *     "transmitPackets":72,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:06","port":"0","receivePackets":0,
     *     "transmitPackets":0,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:06","port":"1","receivePackets":27,
     *     "transmitPackets":290,"collisionCount":0,
     *     "receiveFrameError":0,"receiveOverRunError":0,"receiveCrcError":0
     *     },
     *     {"node":"00:00:00:00:00:00:00:06","port":"2","receivePackets":23,
     *     "transmitPackets":285,"collisionCount":0,
     *     "receiveFrameError":0,"receiveOverRunError":0,"receiveCrcError":0
     *     },
     *     {"node":"00:00:00:00:00:00:00:06","port":"3","receivePackets":61,
     *     "transmitPackets":55,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:05","port":"0","receivePackets":0,
     *     "transmitPackets":0,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     "node":"00:00:00:00:00:00:00:05","port":"1","receivePackets":51,
     *     "transmitPackets":51,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0},
     *     {"node":"00:00:00:00:00:00:00:05","port":"2","receivePackets":52,
     *     "transmitPackets":54,"collisionCount":0,"receiveFrameError":0,
     *     "receiveOverRunError":0,"receiveCrcError":0}]
     **/
    ...
    public List<NodeConnectorStatisticsAndPortNumberMap> getQosDetails() {
        ...
        try {
            ...
            LOGGER.error("Unable to retrieve Node Connector Statistics ");
        }

        LOGGER.info("list property" + list);
        if (list == null) {
            throw new ServiceUnavailableException("SDNi QoS Service is not available. Could be down for maintanence");
        }
        return list;
    }
}
